...
## 10) Troubleshooting de PR (conflictos de merge)

Si GitHub muestra conflictos en `README.md` o `app.py`, crea una rama nueva desde `main`, copia esta carpeta `meeting_recorder_app/` y abre una PR limpia para evitar arrastrar historial conflictivo.
